...
async def start_bot(bot: Bot):
    ...
    apscheduler_task.add_job(push_pay_user, IntervalTrigger(days=1, start_date=datetime.now()+timedelta(seconds=15), end_date=datetime.now()+timedelta(days=2)), args=[bot])
